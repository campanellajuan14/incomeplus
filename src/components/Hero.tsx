        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              {/* Watch demo button - positioned separately for better visual hierarchy */}
          ...
          >
            {/* Main Image Card with animated border light effect */}
            <div className="relative z-10">
              {/* Animated border with light streaks */}
